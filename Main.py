...
def Home():
        ...
        message1 = tk.Label(window, text="Heart Disease Prediction Using ML" ,bg=bgcolor  ,fg=fgcolor  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
        message1.place(x=100, y=5)
        ...
        def SVMprocess():
                ...
                if sym != "":
                        svm.process(sym)
                        tm.showinfo("Input", "SVM Linear Kernel Finished Success")
                else:
                        tm.showinfo("Input error", "Select Dataset File")
        ...
        proc = tk.Button(window, text="RF", command=RFprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
        proc.place(x=100, y=600)
        proc1 = tk.Button(window, text="SVM", command=SVMprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
        proc1.place(x=250, y=600)
        

        LRbutton = tk.Button(window, text="LR", command=LRprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
        LRbutton.place(x=400, y=600)


        RFbutton = tk.Button(window, text="DT", command=DTProcess  ,fg=fgcolor   ,bg=bgcolor1 ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
        RFbutton.place(x=550, y=600)

        SVMbutton = tk.Button(window, text="XGBOOST", command=CNNprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
        SVMbutton.place(x=700, y=600)

        PRbutton = tk.Button(window, text="Predict", command=Predictprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
